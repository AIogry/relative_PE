"""
modify based on the train_single_model with cached data support.
"""
import torch
import torch.nn.functional as F
from torch.utils.data import DataLoader, Dataset  # 添加 Dataset import
...
import random
import numpy as np
import pickle  # 添加 pickle import
...
def run_experiment(cfg: TrainConfig, max_steps: int, save_interval: int, device: torch.device, results_filename: str, use_streaming: bool, 
                   train_cache_path=None, val_cache_path=None):  # 添加缓存路径参数
    """
