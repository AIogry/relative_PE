...
@dataclass
class SpeedMonitor:         # monitor the training process speed, skip
...
@dataclass
class LRMonitor:            # monitor the training process learning rate, skip
...
class Trainer:
    ...
    def split_batch(self, batch: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if batch_size <= microbatch_size:
            ...
            micro_batches = {}
            for key, value in batch.items():            # token to its ID
