...
def main():
    ...
    parser.add_argument("--train_size", type=int, default=5000000, help="Max training samples to load")
    ...
    try:
        ...
        print("Fallback to OLMo internal Tokenizer...")
    ...
    # 使用 load_from_disk 直接读取 Arrow 格式
    ...
    # 制作 Chunk 函数 (Seq Len + 1 以便生成输入和标签)
    ...
    print("Tokenizing and Chunking Training Data (This might take a moment)...")
    ...
    processed_eval_dataset = eval_dataset.map(tokenize_train, batched=True, batch_size=1000, remove_columns=eval_dataset.column_names)
