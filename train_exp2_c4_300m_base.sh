...
#SBATCH --output=/data/qijunrong/03-proj/PE/logs/exp2_c4_300M/tmp_base_%j.out
#SBATCH --error=/data/qijunrong/03-proj/PE/logs/exp2_c4_300M/tmp_base_%j.err
...
function cleanup {
    rm -f /data/qijunrong/03-proj/PE/logs/exp2_c4_300M/tmp_base_${JOB_ID}.out
    rm -f /data/qijunrong/03-proj/PE/logs/exp2_c4_300M/tmp_base_${JOB_ID}.err
}
trap cleanup EXIT
